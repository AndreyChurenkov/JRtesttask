...
public class Player {
    /*
     * Аннотация @Id помечает поле как поле первичного ключа. Когда поле первичного ключа
     * определяется, что значение первичного ключа автоматически вводится в это поле ObjectDB.
     *
     * Аннотация @GeneratedValue указывает, что первичный ключ автоматически выделяется ObjectDB.
     */
